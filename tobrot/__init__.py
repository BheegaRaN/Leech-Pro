...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@BMLeechFastBot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "extract@BMLeechFastBot")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "archive@BMLeechFastBot")
...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@BMLeechFastBot")
...
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel@BMLeechFastBot")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsize")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@BMLeechFastBot")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumbnail@BMLeechFastBot")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumbnail@BMLeechFastBot")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdl@BMLeechFastBot")
...
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename@BMLeechFastBot")
TOGGLE_VID = os.environ.get("TOGGLE_VID", "upload_vid@BMLeechFastBot")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "upload_doc@BMLeechFastBot")
