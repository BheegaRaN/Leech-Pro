...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@BMSeriesHunterBot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "extract@BMSeriesHunterBot")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "archive@BMSeriesHunterBot")
...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@BMSeriesHunterBot")
...
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel@BMSeriesHunterBot")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsize")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@BMSeriesHunterBot")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumbnail@BMSeriesHunterBot")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumbnail@BMSeriesHunterBot")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdl@BMSeriesHunterBot")
...
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename@BMSeriesHunterBot")
TOGGLE_VID = os.environ.get("TOGGLE_VID", "upload_vid@BMSeriesHunterBot")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "upload_doc@BMSeriesHunterBot")
